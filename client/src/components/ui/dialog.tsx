...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-center sm:text-left sticky top-0 z-40 bg-background -mx-6 -mt-6 p-6 border-b",
      className
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 sticky bottom-0 z-40 bg-background -mx-6 -mb-6 p-6 border-t",
      className
    )}
    {...props}
  />
